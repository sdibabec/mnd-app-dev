...
$select = "SELECT bp.* FROM CatDatosContacto bp WHERE bp.eCodDatoContacto = ".($_GET['v1'] ? $_GET['v1'] : 1);
...
?>
  ...
  if (file) {
    ...
    <form id="datos" name="datos" action="<?=$_SERVER['REQUEST_URI']?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="eCodDatoContacto" id="eCodDatoContacto" value="<?=($_GET['v1'] ? $_GET['v1'] : 1)?>">

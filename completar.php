...
$select = "SELECT * FROM SisUsuarios WHERE eCodUsuario = $eCodUsuario";
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="" method="post" name="Datos" id="Datos">
                                <input type="hidden" name="eCodUsuario" id="ecodUsuario" value="<?=$_GET['v1'];?>">
                                <input type="hidden" name="eCodPerfil" id="eCodPerfil" value="4">
                                ...
                                <div class="form-group">
                                    <label>E-mail</label>
                                    <input class="au-input au-input--full" type="email" id="tCorreo" name="tCorreo" placeholder="E-mail" value="<?=$rUsuario{'tCorreo'};?>">
                                </div>
                                <div class="form-group">
...
Fecha de &uacute;ltima actualizaci&oacute;n Agosto del 2019.
    ...
    <script>
      ...
      function enviar(cadena)
      {
            ...
            $.ajax({
              type: "POST",
              url: "http://app.e-micapacitacion.com/cla/cata-usr-reg.php",
              data: cadena,
